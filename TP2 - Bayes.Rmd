...
```{r}
#Punto 4
muestra1 <- tabla3$muestra[1:5000]
muestra2 <- tabla3$muestra[5001:10000]
muestra3 <- tabla3$muestra[10001:15000]
...
percentiles <- data.frame(
  Muestra = c("1", "2", "3"),
  Percentile_5 = c(quantile(muestra1, prob = c(0.05)),
                  quantile(muestra2, prob = c(0.05)),
                  quantile(muestra3, prob = c(0.05))
                  ),
  Percentil_95 = c(quantile(muestra1, prob = c(0.95)),
                  quantile(muestra2, prob = c(0.95)),
                  quantile(muestra3, prob = c(0.95))
                  )
)
