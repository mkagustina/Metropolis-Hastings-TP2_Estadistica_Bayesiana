...
Utilizando la función de MH construída al comienzo, se obtienen 5000 muestras de una distribución Kumaraswamy con parámetros $a=6$ y $b=2$.
...
Se concluye con la tabla que 5000 muestras correlacionadas con la mejor matriz, $\boldsymbol{\Sigma^5}$, equivalen a 808 y 608 muestras independientes para $\mu_1$ y $\mu_2$, respectivamente. 
...
data.frame (
  ...
  kable_styling(bootstrap_options = c("striped","hover","condensed"),
                latex_options = c("hold_position")) %>%
  add_header_above(c(" " = 1, "Tabla 7: Probabilidades estimadas por distintos métodos" = 3))
